...
const ProgramsPage: React.FunctionComponent<PageProps> = () => (
  <Layout>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid justify-center gap-4 sm:grid-cols-1 md:grid-cols-3">
          {[
            ...
            <div className="px-2 py-16 mb-3 text-center bg-gray-200 rounded">
              <div className="mb-3 text-5xl">{icon}</div>
              <h3 className="mb-2 text-xl font-medium uppercase">{title}</h3>
    ...
    <section className="bg-icterine py-28">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-8 gap-10">
          ...
          <div className="col-span-5">
            <h3 className="flex items-center text-2xl font-bold">
              ...
              <span className="py-1 pl-3 pr-4 ml-4 text-sm font-light text-white rounded-full bg-gradient-to-r from-darkIris to-iris">
    ...
    <section className="bg-gray-800 text-gray-50 py-28">
      <div className="max-w-5xl mx-auto">
        <div className="text-center">
